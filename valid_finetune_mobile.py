...
"""
Created by jayveehe on 2018/9/25.
...
parser.add_argument('-modelpath', type=str, default='weights/mobilenet_weights.h5',
                    help='Whether to tank the images after they have been scored')

parser.add_argument('-output', type=str, default='output/mobile_eval.txt',
                    help='Whether to tank the images after they have been scored')
...
with tf.device('/CPU:0'), open(args.output, 'w') as fout:
    ...
    model.load_weights('%s' % args.modelpath)
